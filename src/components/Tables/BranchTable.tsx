...
const BranchTable = () => {
  ...
  return (
    <div className="rounded-[10px] bg-white shadow-1 dark:bg-gray-dark dark:shadow-card table-responsive">
          ...
          >
            ...
            <div className="col-span-1 flex items-center justify-center">
              <button
                ...
                className="border border-primary text-primary rounded-full rounded-[2px] px-5 py-1 lg:px-10 xl:px-5"
              >
                Confirm
              </button>
            </div>
        ...
        <Modal isOpen={isConfirmOpen} onClose={handleConfirmClose}>
          <div className="p-5">
            <p className="mb-4 text-center justify-center">
              Are you sure you want to change this User Branches?
            </p>
