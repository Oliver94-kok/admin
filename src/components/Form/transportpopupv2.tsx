// src/components/TransportPopup.tsx
...
interface TransportPopupv2Props {
    isOpen: boolean;
    onClose: () => void;
...
const TransportPopupv2: React.FC<TransportPopupv2Props> = ({ isOpen, onClose, onAddItem, data, type, }) => {
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose}>
            <div className={`popup ${isOpen ? 'open' : ''}`}>
                <div className="p-4">
                    <h2 className="text-lg font-semibold mb-2">{dict.salary.addtransport}</h2>
...
export default TransportPopupv2;
