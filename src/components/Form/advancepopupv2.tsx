// src/components/AdvancePopup.tsx
...
const AdvancePopupv2: React.FC<AdvancePopupv2Props> = ({ isOpen, onClose, onAddItem, type, data }) => {
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose}>
            <div className={`popup ${isOpen ? 'open' : ''}`}>
                <div className="p-4">
                    <h2 className="text-lg font-semibold mb-2">{dict.salary.addadvance}</h2>
