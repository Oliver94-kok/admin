...
const AllowPopup: React.FC<AllowPopupProps> = ({ isOpen, onClose, onAddItem, id, items, type, name, branch }) => {
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose}>
            <div className={`popup ${isOpen ? 'open' : ''}`}>
                <div className="p-4">
                    <h2 className="text-lg font-semibold mb-2">{dict.salary.addallow}</h2>
