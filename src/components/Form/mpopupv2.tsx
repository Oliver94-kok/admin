...
const MPopupv2: React.FC<MPopupPropsv2> = ({ isOpen, onClose, onAddItem, data, type, }) => {
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose}>
            <div className={`popup ${isOpen ? 'open' : ''}`}>
                <div className="p-4">
                    <h2 className="text-lg font-semibold mb-2">{dict.salary.addm}</h2>
