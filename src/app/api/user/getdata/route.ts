...
export const POST = async (req: Request) => {
    try {
        ...
        const users = await db.user.findFirst({ where: { id: userId, role: "USER", isDelete: false }, select: { AttendBranch: { select: { team: true, branch: true, clockIn: true, clockOut: true } } } })
        ...
        let result = {
            ...
            userBranch: users.AttendBranch?.branch,
            branchs
        }
